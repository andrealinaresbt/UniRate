  ...
  <TouchableOpacity style={styles.resultItem} onPress={onPress}>
    <View style={styles.content}>
      ...
      <View style={styles.footer}>
        ...
        {/* Mostrar cantidad de reseñas para ambos tipos */}
...
const styles = StyleSheet.create({
  ...
  resultName: { fontSize: 18, fontWeight: '600', color: '#003087', flex: 1, marginRight: 12, lineHeight: 24 },
  typeBadge: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16, minWidth: 80, alignItems: 'center' },
  professorBadge: { backgroundColor: '#2b529a' },
  courseBadge: { backgroundColor: '#ff8200' },
  ...
  ratingText: { fontSize: 16, fontWeight: '600', color: '#003087' },
  reviewCount: { fontSize: 14, color: '#888', fontStyle: 'italic' },
});
